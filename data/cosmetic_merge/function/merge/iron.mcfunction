...
data modify entity @n[type=armor_stand,name=CosmeticMerge] equipment.mainhand.components.minecraft:attribute_modifiers set value [{id:"armor",type:"armor",amount:2,operation:"add_value"},{id:"armor_toughness",type:"armor_toughness",amount:0,operation:"add_value"}]
...
tellraw @s {"text":"Iron armor + enchantments applied to your hat!","color":"green"}
