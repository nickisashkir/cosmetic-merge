...
data modify entity @n[type=armor_stand,name=CosmeticMerge] equipment.mainhand.components.minecraft:attribute_modifiers set value [{id:"minecraft:base_attack_damage",type:"attack_damage",amount:8,operation:"add_value",slot:"mainhand"},{id:"minecraft:base_attack_speed",type:"attack_speed",amount:-3.1,operation:"add_value",slot:"mainhand"}]
...
tellraw @s {"text":"Iron axe stats + enchantments applied to your cosmetic!","color":"green"}
