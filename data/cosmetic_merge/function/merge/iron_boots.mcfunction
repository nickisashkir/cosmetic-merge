...
data modify entity @n[type=armor_stand,name=CosmeticMerge] equipment.mainhand.components.minecraft:attribute_modifiers set value [{id:"armor",type:"armor",amount:2,operation:"add_value"}]
